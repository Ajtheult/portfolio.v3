    ...
    return (
      <div>
        ...
        <ul id="slide-out" className="sidenav">
          ...
          <li>
            <a className="waves-effect" href="/portfolio-version-2">
              Home
            </a>
          </li>

          <li>
            <a className="waves-effect" href="/portfolio-version-2/skills">
              Skills
            </a>
          </li>
          <li>
            <a className="waves-effect" href="/portfolio-version-2/mywork">
              Work
            </a>
          </li>
          <li>
            <a
              ...
              href="/portfolio-version-2/testimonials"
            >
              Testimonials
            </a>
          </li>
