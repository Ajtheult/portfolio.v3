        ...
        <div class="col s6">
          ...
          <div class="card-panel white">
            <h5 class="black-text move_the_name">
              Godwin P edzisai Dzvapatsva (Head of Curriculum and Learning)
            </h5>
            <span class="black-text enlarge_paragraph">
              Asaph has an analytical and rational mind when it comes to
              programming challenges. He would raise questions and discussions
              whenever in doubt. I recommend him.
            </span>
          </div>
        </div>
      </div>
