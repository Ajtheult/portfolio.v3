      ...
      <div className="row">
        <div className="col s6 left">
          <div className="card">
            ...
            <div className="card-content">
              <p className="black_text my_work_desc">
                I am attempting to recreate Whatsapp with the knowledge I have
                acquired thus far at Life Choices Coding Academy. <br />{" "}
            ...
            <div className="link-size">
              <a
                href="https://github.com/Ajtheult/IT-Logger.git"
                className="waves-effect waves-light btn black center"
                rel="noopener noreferrer"
                target="_blank"
              >
                Github
